      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md px-4">
        ...
        <div className="text-center">
          ...
          <div className="flex justify-center mb-4">
            <div className="h-14 overflow-hidden rounded-xl shadow-md">
              <Image
                src="/haier-logo.jpg"
                alt="Haier"
                width={100}
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md px-4">
        <div className="bg-white py-8 px-6 sm:px-10 shadow-xl shadow-slate-200/60 rounded-3xl border border-slate-100">
          <form className="space-y-5" onSubmit={handleSubmit}>
            {error && (
              <div className="p-3.5 rounded-xl bg-red-50 border border-red-200/80 flex items-start gap-3 text-red-700 text-sm">
